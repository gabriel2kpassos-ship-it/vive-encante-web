...
export function DeleteKitButton({ id }: { id: string }) {
  ...
  async function handleDelete() {
    ...
    try {
      ...
      router.replace("/admin/kits"); // ✅ garante sair do [id]
    } catch (e: any) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="text-sm font-semibold text-red-600 hover:underline underline-offset-2 disabled:opacity-60 disabled:hover:no-underline"
    >
